...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'teemu
	...
	`(org-hide ((,class (:foreground ,base62))))
        `(org-level-1 ((,class (:bold t :foreground ,base74 :height 1.1))))
        `(org-level-2 ((,class (:bold nil :foreground ,base68))))
        `(org-level-3 ((,class (:bold t :foreground ,base62))))
        `(org-level-4 ((,class (:bold nil :foreground ,base39))))
        ...
        `(org-done ((,class (:bold t :foreground ,base39))))
        `(org-warning ((,class (:underline t :foreground ,warning))))
        `(org-agenda-structure ((,class (:weight bold :foreground ,base68 :box (:color ,base62) :background ,base33))))
