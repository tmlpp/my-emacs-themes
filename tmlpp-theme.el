 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'tmlpp
	...
	`(org-verbatim ((,class (:foreground ,base62))))
        `(org-agenda-calendar-event ((,class (:foreground ,base80))))
        ...
        `(org-scheduled-today ((,class (:foreground ,type :weight bold))))
        `(org-scheduled-previously ((,class (:foreground ,builtin :weight bold))))
        `(org-special-keyword ((,class (:foreground ,base51))))
        `(org-time-grid ((,class (:foreground ,base51))))
        `(org-todo ((,class (:foreground ,builtin :bold t))))
        `(org-upcoming-deadline ((,class (:foreground ,var))))
